...
alert("Hola " + preguntaNombre + ", hoy adivinaremos tu anio de nacimiento, con un simple truco matematico")

const elegirNumero = parseInt(prompt("Elija un numero del 1 al 9. *1,2,3,4,5,6,7,8,9*"))
    console.log(preguntaNombre + " su numero elegido es el " + elegirNumero)
    if ((elegirNumero > 0) && (elegirNumero < 10)){
        const sumaA = (((elegirNumero * 2) + 5) *50)
        console.log("La suma va en " + sumaA)

    
        const preguntaCumple = prompt(preguntaNombre + ", si has estado de cumpleanos este ano elije otro numero del 1 al 9, de lo contrario puedes elegir cualquier otro numero mayor a 9.")
            if ((preguntaCumple > 0) && (preguntaCumple < 10)){
                console.log(preguntaNombre + ", No ha estado de cumple.")
                const SumaAA = (sumaA + 1773);
                console.log("La suma va en " + SumaAA)
                

            } else {
                console.log(preguntaNombre + ", ha estado de cumple.")
                const SumaAB = (sumaA + 1772);
                console.log("La suma va en " + SumaAB)
            }
            const preguntaFinal = parseInt(prompt("A tu edad sumale 1"))
                const edad = (preguntaFinal - 1)
                const anioNacimiento =(2023 - edad)
                console.log(preguntaNombre + " Su edad es: " + edad)
